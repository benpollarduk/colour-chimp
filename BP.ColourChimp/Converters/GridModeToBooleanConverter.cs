...
namespace BP.ColourChimp.Converters
{
    ...
    internal class GridModeToBooleanConverter : IValueConverter
    {
        ...
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
            ...
            return mode == GridMode.FitToArea;
        }
        ...
        public object ConvertBack(object value, Type targetType, object parameter, CultureInfo culture)
        {
            if (!bool.TryParse(value?.ToString() ?? string.Empty, out var b))
                return GridMode.FitToArea;

            return b ? GridMode.FitToArea : GridMode.MaintainSize;
        }
